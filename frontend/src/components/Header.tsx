...
export function Header({ theme, onToggleTheme }: HeaderProps) {
  return (
    <header className="relative overflow-hidden rounded-[2rem] border border-white/70 bg-white/80 p-6 shadow-soft backdrop-blur md:p-10 dark:border-white/10 dark:bg-white/[0.05]">
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_left,_rgba(94,194,183,0.24),_transparent_36%),radial-gradient(circle_at_bottom_right,_rgba(255,138,91,0.18),_transparent_30%)] dark:bg-[radial-gradient(circle_at_top_left,_rgba(94,194,183,0.16),_transparent_32%),radial-gradient(circle_at_bottom_right,_rgba(255,138,91,0.14),_transparent_28%)]" />
      <div className="relative">
        <div className="flex flex-wrap items-center justify-between gap-4">
          <p className="font-mono text-xs uppercase tracking-[0.35em] text-slate dark:text-slate-400">Resume Intelligence Studio</p>
          <button
            className="inline-flex items-center gap-2 rounded-full border border-ink/10 bg-white/75 px-4 py-2 text-sm font-semibold text-ink shadow-sm transition hover:border-sea hover:text-ink dark:border-white/10 dark:bg-white/[0.04] dark:text-slate-100 dark:hover:border-sea"
        ...
        <div className="mt-8 grid gap-8 lg:grid-cols-[minmax(0,1.15fr)_minmax(300px,0.85fr)] lg:items-end">
          <div className="space-y-5">
            <div className="space-y-3">
              ...
              <p className="max-w-2xl text-base leading-7 text-slate-700 md:text-lg dark:text-slate-300">
            ...
            <div className="flex flex-wrap gap-3">
              <span className="rounded-full border border-ink/10 bg-white/70 px-4 py-2 text-sm font-medium text-slate-700 dark:border-white/10 dark:bg-white/[0.04] dark:text-slate-300">
          ...
          <div className="grid gap-4 rounded-[1.75rem] bg-ink p-5 text-white dark:bg-[#08161f]">
            ...
            <div className="grid gap-3 text-sm leading-6 text-white/85">
