  ...
  return (
    <section className="grid gap-4 lg:grid-cols-[1.1fr_0.9fr]">
      <div className="rounded-[2rem] border border-ink/10 bg-white p-6 shadow-soft transition-colors duration-300 md:p-8 dark:border-white/10 dark:bg-white/[0.04]">
        <div className="mb-5">
          <p className="font-mono text-xs uppercase tracking-[0.35em] text-slate dark:text-slate-400">Market Gaps</p>
        ...
        {hasMissingSkills ? (
          ...
          <div className="flex min-h-[320px] items-center justify-center rounded-[1.5rem] border border-dashed border-ink/10 bg-mist px-8 text-center transition-colors duration-300 dark:border-white/10 dark:bg-white/[0.03]">
        ...
        {liveMissingDetails.length ? (
          <div className="mt-5 grid gap-3">
            {liveMissingDetails.slice(0, 3).map((detail) => (
              <article key={detail.skill} className="rounded-[1.25rem] bg-mist p-4 transition-colors duration-300 dark:bg-white/[0.03]">
                <div className="flex items-center justify-between gap-3">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-xs font-semibold uppercase tracking-[0.2em] text-slate dark:text-slate-400">
        ...
        {calibratedMissingDetails.length ? (
          <div className="mt-5 grid gap-3">
            <p className="text-xs font-semibold uppercase tracking-[0.24em] text-slate dark:text-slate-400">Calibration-only gaps</p>
      ...
      <div className="rounded-[2rem] border border-ink/10 bg-white p-6 shadow-soft transition-colors duration-300 md:p-8 dark:border-white/10 dark:bg-white/[0.04]">
        <p className="font-mono text-xs uppercase tracking-[0.35em] text-slate dark:text-slate-400">Matched Skills</p>
        ...
        <div className="mt-6 flex flex-wrap gap-3">
          {matchedSkills.length ? (
            ...
            <p className="text-sm leading-6 text-slate-700 dark:text-slate-300">No strong market-skill overlaps yet. That is fixable once we target the missing skills above.</p>
          )}
        </div>
