...
SKILL_PATTERNS = {
    ...
    "software development": [r"\bsoftware development\b", r"\bapplication development\b"],
    "software engineering": [r"\bsoftware engineering\b"],
    "software architecture": [r"\bsoftware architecture\b", r"\bsoftware architect(?:ure|ing)?\b"],
    "systems architecture": [r"\bsystems? architecture\b", r"\bsystem design\b"],
    "web development": [r"\bweb development\b", r"\bweb app(?:lication)? development\b"],
    "front-end development": [r"\bfront[- ]end development\b", r"\bfrontend development\b"],
    "full stack development": [r"\bfull[- ]stack development\b", r"\bfullstack development\b"],
    "mobile development": [r"\bmobile development\b", r"\bmobile app(?:lication)? development\b"],
    "cloud computing": [r"\bcloud computing\b"],
    "cloud solutions": [r"\bcloud solutions?\b", r"\bcloud based applications?\b", r"\bcloud-based applications?\b"],
    "agile": [r"\bagile\b", r"\bagile methodology\b", r"\bagile methodologies\b"],
    "scrum": [r"\bscrum\b"],
    "pandas": [r"\bpandas\b"],
    "numpy": [r"\bnumpy\b"],
    ...
    "artificial intelligence": [r"\bartificial intelligence\b", r"\bai driven\b", r"\bai-powered\b", r"\bai powered\b"],
    "ai/ml": [r"\bai/ml\b", r"\bai ml\b"],
    "ai ethics": [r"\bai ethics\b", r"\bethical ai\b"],
    "ai modeling": [r"\bai model(?:ing|ling)\b"],
    "explainable ai": [r"\bexplainable ai\b", r"\bxai\b"],
    "predictive modeling": [r"\bpredictive model(?:ing|ling)\b", r"\bprediction models?\b"],
    "predictive analytics": [r"\bpredictive analytics\b"],
    "data science": [r"\bdata science\b"],
    "data engineering": [r"\bdata engineering\b"],
    "big data": [r"\bbig data\b"],
    "big data analytics": [r"\bbig data analytics\b"],
    "big data processing": [r"\bbig data processing\b"],
    ...
    "c++": [r"\bc\+\+\b"],
    "c#": [r"(?<![A-Za-z0-9])c#(?![A-Za-z0-9])", r"\bc sharp\b"],
    ...
    "spring framework": [r"\bspring framework\b", r"\bspring\b"],
    ...
    "real-time systems": [r"\breal[- ]time systems?\b"],
    "real-time data processing": [r"\breal[- ]time data processing\b"],
    "iot solutions": [r"\biot solutions?\b"],
    "telecommunications": [r"\btelecommunications?\b", r"\btelecom\b"],
    ...
    "team leadership": [r"\bteam leadership\b", r"\bteam management\b"],
    "market research": [r"\bmarket research\b"],
    "customer analytics": [r"\bcustomer analytics\b"],
    "customer support systems": [r"\bcustomer support systems?\b"],
    ...
    "brand management": [r"\bbrand management\b"],
    "marketing analytics": [r"\bmarketing analytics\b"],
    ...
    "ui/ux design": [r"\bui/ux design\b", r"\bui ux design\b"],
    "web design": [r"\bweb design\b"],
    "branding": [r"\bbranding\b"],
    "logo design": [r"\blogo design\b"],
    "adobe photoshop": [r"\badobe photoshop\b", r"\bphotoshop\b"],
    "adobe illustrator": [r"\badobe illustrator\b", r"\billustrator\b"],
    "sketch": [r"\bsketch\b"],
    "e-commerce design": [r"\be[- ]commerce design\b", r"\becommerce design\b"],
    ...
    "data security": [r"\bdata security\b"],
    "public health": [r"\bpublic health\b"],
    "program development": [r"\bprogram development\b"],
}
...
SKILL_LABEL_ALIASES = {
    ...
    "ci cd": "ci/cd",
    "cicd": "ci/cd",
    "cloud based applications": "cloud solutions",
    "cloud-based applications": "cloud solutions",
    "crm systems": "crm",
